...
/*     13 */	add	x0, sp, 48
/*     14 */	dup	z1.s, 0
/*     14 */	st1w	z1.s, p0, [x20, 0, mul vl]	//  "y"
/*     13 */	add	z0.s, z0.s, 0
/*     13 */	st1w	z0.s, p0, [x0, 0, mul vl]	//  "x"
/*     17 */	ptrue	p0.d, VL4
/*     18 */	index	z0.d, 0, 2
/*     18 */	ld1sw	z1.d, p0/z, [x0, 0, mul vl]	//  "x"
/*     18 */	mov	x0, 0
/*     18 */	add	x0, x20, x0, lsl #2
/*     18 */	st1w	z1.d, p0, [x0, z0.d, lsl #2]	//  "y"
/*     21 */	mov	w22, 8
/*     22 */	mov	x21, 0
/*     22 */	adrp	x0, .LR.2
/*     22 */	add	x19, x0, :lo12:.LR.2
.L85:					// :entr:term
/*     22 */	ldr	w1, [x20, x21, lsl #2]	//  "y"
/*     22 */	mov	x0, x19
/*     22 */	bl	printf
/*     23 */	add	x21, x21, 1
/*     23 */	subs	w22, w22, 1
