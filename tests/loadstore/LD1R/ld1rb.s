...
/*     13 */	add	x0, sp, 48
/*     14 */	dup	z1.b, 0
/*     14 */	st1b	z1.s, p0, [x22, 0, mul vl]	//  "y"
/*     13 */	add	z0.s, z0.s, 0
/*     13 */	st1b	z0.s, p0, [x0, 0, mul vl]	//  "x"
/*     17 */	ptrue	p0.b, VL8
/*     18 */	ld1rb	z0.b, p0/z, [x0, 2]
/*     18 */	st1b	z0.b, p0, [x22, 0, mul vl]	//  "y"
/*     21 */	mov	w20, 8
/*     22 */	mov	x21, 0
/*     22 */	adrp	x0, .LR.2
/*     22 */	add	x19, x0, :lo12:.LR.2
.L85:					// :entr:term
/*     22 */	ldrb	w1, [x22, x21]	//  "y"
/*     22 */	mov	x0, x19
/*     22 */	bl	printf
/*     23 */	add	x21, x21, 1
/*     23 */	subs	w20, w20, 1
