...
/*     32 */	add	w2, w2, 32
/*     32 */	subs	w0, w0, 1
/*     31 */	st1h	z2.s, p1, [x21, x1, lsl #1]	//  "y"
/*     30 */	add	z1.s, z1.s, z0.s
/*     30 */	st1h	z1.s, p1, [x3, x1, lsl #1]	//  "x"
/*     32 */	add	x1, x1, 16
/*     32 */	bne	.L62
/*     34 */	ld1h	z0.h, p4/z, [x3, 0, mul vl]	//  "x"
/*     35 */	st1h	z0.h, p0, [x21, 0, mul vl]	//  "y"
/*     37 */	mov	w22, 32
/*     38 */	mov	x20, 0
/*     38 */	adrp	x0, .LR.2
/*     38 */	add	x19, x0, :lo12:.LR.2
.L65:					// :entr:term
/*     38 */	ldrsh	w1, [x21, x20, lsl #1]	//  "y"
/*     38 */	mov	x0, x19
/*     38 */	bl	printf
/*     39 */	add	x20, x20, 1
/*     39 */	subs	w22, w22, 1
