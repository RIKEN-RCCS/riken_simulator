...
/*     11 */	ptrue	p2.s, VL1
/*     30 */	st1w	z0.s, p5, [x0, 0, mul vl]	//  "x"
/*     23 */	nor	p3.b, p1/z, p3.b, p3.b
/*     31 */	st1w	z1.s, p5, [x22, 0, mul vl]	//  "y"
/*     24 */	nor	p0.b, p3/z, p0.b, p0.b
/*     34 */	ld1w	z0.s, p4/z, [x0, 0, mul vl]	//  "x"
/*     25 */	nor	p2.b, p0/z, p2.b, p2.b
/*     35 */	st1w	z0.s, p2, [x22, 0, mul vl]	//  "y"
/*     37 */	mov	w20, 16
/*     38 */	mov	x21, 0
/*     38 */	adrp	x0, .LR.2
/*     38 */	add	x19, x0, :lo12:.LR.2
.L65:					// :entr:term
/*     38 */	ldr	w1, [x22, x21, lsl #2]	//  "y"
/*     38 */	mov	x0, x19
/*     38 */	bl	printf
/*     39 */	add	x21, x21, 1
/*     39 */	subs	w20, w20, 1
