	.text
	.file	"/tmp/himenoBMTxp-static-f4c8ff.ll"
...
.Lcfi11:
	...
	adrp	x20, .C332_MAIN_
	adrp	x0, .C334_MAIN_
	add	x20, x20, :lo12:.C332_MAIN_
	add	x0, x0, :lo12:.C334_MAIN_
	mov	w2, #22
	mov	x1, x20
	bl	f90io_src_info03
	adrp	x21, .C335_MAIN_
	add	x21, x21, :lo12:.C335_MAIN_
	mov	x0, x21
	mov	x1, xzr
	mov	x2, x19
	mov	x3, x19
	...
	adrp	x22, .C343_MAIN_
	adrp	x23, .C285_MAIN_
	add	x22, x22, :lo12:.C343_MAIN_
	add	x23, x23, :lo12:.C285_MAIN_
	adrp	x2, .C352_MAIN_
	add	x2, x2, :lo12:.C352_MAIN_
	orr	w3, wzr, #0xc
	mov	x0, x22
	mov	x1, x23
	bl	f90io_encode_fmt
...
.LBB5_2:                                // %L.LB6_398
	adrp	x19, .C332_MAIN_
	adrp	x0, .C368_MAIN_
	add	x19, x19, :lo12:.C332_MAIN_
	add	x0, x0, :lo12:.C368_MAIN_
	mov	w2, #22
	mov	x1, x19
	bl	f90io_src_info03
	adrp	x21, .C335_MAIN_
...
.Lcfi16:
	...
	bl	f90io_sc_ch_ldw
	bl	f90io_ldw_end
	adrp	x8, .C371_readparam_
	ldr	x8, [x8, :lo12:.C371_readparam_]
	mov	w9, #8224
	mov	x0, sp
	str	x8, [sp]
	strh	w9, [sp, #8]
...
.LBB9_4:                                // %L.LB10_388
	...
	cmp	w3, #2                  // =2
	b.gt	.LBB9_6
// BB#5:                                // %L.LB10_388.L.LB10_392_crit_edge
                                        //   in Loop: Header=BB9_4 Depth=2
	add	x8, x8, #1              // =1
	cmp	x8, x22
	b.ne	.LBB9_4
	b	.LBB9_13
.LBB9_6:                                // %L.LB10_391.preheader
                                        //   in Loop: Header=BB9_4 Depth=2
...
.LBB9_7:                                // %L.LB10_391
	...
	cmp	w8, #2                  // =2
	b.gt	.LBB9_9
// BB#8:                                // %L.LB10_391.L.LB10_395_crit_edge
                                        //   in Loop: Header=BB9_7 Depth=3
	add	x22, x22, #1            // =1
	cmp	x22, x3
	b.ne	.LBB9_7
	b	.LBB9_12
.LBB9_9:                                // %L.LB10_394.preheader
                                        //   in Loop: Header=BB9_7 Depth=3
...
// BB#11:                               // %middle.block63
	...
	cmp	x22, x3
	b.ne	.LBB9_7
.LBB9_12:                               // %L.LB10_392.loopexit
                                        //   in Loop: Header=BB9_4 Depth=2
	ldp	x22, x8, [sp, #136]     // 8-byte Folded Reload
	cmp	x8, x22
	b.ne	.LBB9_4
.LBB9_13:                               // %L.LB10_389.loopexit
                                        //   in Loop: Header=BB9_2 Depth=1
...
.LBB9_23:                               // %L.LB10_386
	ret
.Lfunc_end9:
	.size	jacobi_, .Lfunc_end9-jacobi_
                                        // -- End function
...
.Lcfi27:
	...
	ret
.Lfunc_end10:
	.size	second_, .Lfunc_end10-second_
	.cfi_endproc
                                        // -- End function
	.type	.C393_MAIN_,@object     // @.C393_MAIN_
...
.C393_MAIN_:
	...
	.type	.C392_MAIN_,@object     // @.C392_MAIN_
	.p2align	2
.C392_MAIN_:
	.word	137                     // 0x89
	.size	.C392_MAIN_, 4

	.type	.C390_MAIN_,@object     // @.C390_MAIN_
	.p2align	2
.C390_MAIN_:
	.ascii	" MFLOPS:"
	.size	.C390_MAIN_, 8

	.type	.C389_MAIN_,@object     // @.C389_MAIN_
	.p2align	2
.C389_MAIN_:
	.word	135                     // 0x87
	.size	.C389_MAIN_, 4

	.type	.C388_MAIN_,@object     // @.C388_MAIN_
	.p2align	2
.C388_MAIN_:
	.ascii	" Gosa :"
	.size	.C388_MAIN_, 7
...
.C386_MAIN_:
	...
	.type	.C385_MAIN_,@object     // @.C385_MAIN_
	.p2align	4
.C385_MAIN_:
...
.C369_MAIN_:
	...
	.type	.C368_MAIN_,@object     // @.C368_MAIN_
	.p2align	2
.C368_MAIN_:
	.word	113                     // 0x71
	.size	.C368_MAIN_, 4
...
.C362_MAIN_:
	...
	.type	.C361_MAIN_,@object     // @.C361_MAIN_
	.p2align	4
.C361_MAIN_:
	.ascii	" Start rehearsal measurement process."
	.size	.C361_MAIN_, 37

	.type	.C360_MAIN_,@object     // @.C360_MAIN_
	.p2align	2
.C360_MAIN_:
	.word	102                     // 0x66
	.size	.C360_MAIN_, 4
...
.C356_MAIN_:
	...
	.type	.C352_MAIN_,@object     // @.C352_MAIN_
	.p2align	2
.C352_MAIN_:
	.ascii	"(2x,a,e10.5)"
	.size	.C352_MAIN_, 12
...
.C351_MAIN_:
	...
	.type	.C350_MAIN_,@object     // @.C350_MAIN_
	.p2align	2
.C350_MAIN_:
	.ascii	" kmax="
	.size	.C350_MAIN_, 6
...
.C348_MAIN_:
	...
	.type	.C347_MAIN_,@object     // @.C347_MAIN_
	.p2align	2
.C347_MAIN_:
	.word	94                      // 0x5e
	.size	.C347_MAIN_, 4
...
.C340_MAIN_:
	...
	.type	.C339_MAIN_,@object     // @.C339_MAIN_
	.p2align	2
.C339_MAIN_:
	.ascii	" mjmax="
	.size	.C339_MAIN_, 7
...
.C338_MAIN_:
	...
	.type	.C335_MAIN_,@object     // @.C335_MAIN_
	.p2align	2
.C335_MAIN_:
	.word	6                       // 0x6
	.size	.C335_MAIN_, 4
...
.C283_MAIN_:
	...
	.type	.C371_readparam_,@object // @.C371_readparam_
	.p2align	3
.C371_readparam_:
	.ascii	"XS      "
	.size	.C371_readparam_, 8
